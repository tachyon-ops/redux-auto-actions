...
// Generic dispatch
export type GenericDispatch<State> = Dispatch<AnyAction> &
  ThunkDispatch<State, null, AnyAction>;

// Reducer
export type Reducer<StateI, ActionI extends Action<unknown>> = ReducerFromRedux<
  StateI,
  ActionI
>;
